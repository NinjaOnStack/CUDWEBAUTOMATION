import { createShipment } from "../../pages/createPickupShipment";
import { shipmentRouting } from "../../pages/PickupDeliveryRouteForAndroidApp";
...
describe('Shipment Tests', () => {
    ...
    it('Should show newly created shipment under routing screen', () => {
        ...
        ShipmentRouting.searchDragnDropRecordByRefNo(routingData.shipments[0].type);
